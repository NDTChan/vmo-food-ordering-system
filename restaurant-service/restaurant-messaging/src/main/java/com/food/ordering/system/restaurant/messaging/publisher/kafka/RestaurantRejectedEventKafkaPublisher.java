...
@Component
public class RestaurantRejectedEventKafkaPublisher implements OrderRejectedMessagePublisher {
        ...
        try {
            RestaurantApprovalResponseAvroModel restaurantApprovalResponseAvroModel =
                    restaurantMessagingDataMapper
                            .orderApprovedEventToRestaurantApprovalResponseAvroModel(orderRejectedEvent);
